var jsPsychOpenText = (function (jspsych) {
    ...
    const info = {
        ...
        parameters: {
            ...
            /** How long to show trial  - Added by Jakub**/
            trial_duration: {
                type: jspsych.ParameterType.INT,
        ...
        trial(display_element, trial) {
            ...
            display_element.querySelector("#jspsych-survey-text-form").addEventListener("submit", (e) => {
                ...
                for (var index = 0; index < trial.questions.length; index++) {
                    ...
                    // Changed by Jakub Onysk 13/09/2024
                    // var q_element = document.querySelector("#jspsych-survey-text-" + index).querySelector("textarea, input");
                    var q_element = document.querySelector("#jspsych-survey-text-" + index).querySelector("textarea, input[type=submit]");
                ...
                /***
                 * Added by Jakub Onysk 16/09/2024
                 */
