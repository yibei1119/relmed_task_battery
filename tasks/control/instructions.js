...
function setupFuelTrial(config) {
    ...
    function createFuelIcon(container) {
        ...
        fuelIcon.src = '@images/control/fuel.png';
    ...
    const controlInstructionPages = [
        // Page 0: Initial Welcome
        {
            ...
            <div class="instruction-stage">
                ...
                <section class="scene">
                <img class="island-far" src="@images/control/session-specific/${settings.session}/simple_island_${downstreamIsland}.png" alt="Farther island" />
                <div class="overlap-group">
                    <div class="choice-left">
                        ...
                        <img class="ship-left" src="@images/control/simple_ship_${leftShip}.png" alt="Left ship" />
                        <img class="arrow-left" style="visibility: hidden;" src="@images/control/left.png" alt="Left arrow" />
                    </div>
                    <img class="island-near" src="@images/control/simple_island.png" alt="Nearer island" />
                    <div class="choice-right">
                        ...
                        <img class="ship-right" src="@images/control/simple_ship_${rightShip}.png" alt="Right ship" />
                        <img class="arrow-right" style="visibility: hidden;" src="@images/control/left.png" alt="right arrow" />
                    </div>
                </div>
            ...
            <div class="instruction-stage">
                ...
                <div class="overlap-group">
                    <div class="choice-left">
                        ...
                        <img class="ship-left" src="@images/control/simple_ship_${leftShip}.png" alt="Left ship" />
                        <img class="arrow-left" src="@images/control/left.png" alt="left arrow" />
                    </div>
                    <img class="island-near" src="@images/control/simple_island.png" alt="Nearer island" />
                    <div class="choice-right">
                        ...
                        <img class="ship-right" src="@images/control/simple_ship_${rightShip}.png" alt="Right ship" />
                        <img class="arrow-right" src="@images/control/left.png" alt="right arrow" />
                    </div>
                </div>
                ${createOceanCurrents(2)}
                </section>
            ...
            <div class="instruction-stage">
                ...
                <section class="scene">
                    <div class="overlap-group" style="justify-content: space-between;">
                        <div class="choice-left">
                            <img class="ship-left" src="@images/control/simple_ship_${rightShip}.png" alt="Ship" style="opacity: 0;" />
                        </div>
                        <img class="island-near" style="visibility: hidden;" src="@images/control/simple_island.png" alt="Hidden island" />
                        <div class="choice-right">
                            <img class="island-near" src="@images/control/session-specific/${settings.session}/simple_island_${homebaseIsland}.png" alt="Destination island" style="top: -10%;" />
                        </div>
                    </div>
                </section>
                ${createInstructionDialog(`
        ...
        // Page 6: Ending up on the homebase
        {
            ...
            <div class="instruction-stage">
                ...
                <section class="scene">
                    <img class="island-far" src="@images/control/session-specific/${settings.session}/simple_island_${downstreamIsland}.png" alt="Farther island" />
                    <img class="feedback-ship" src="@images/control/simple_ship_${rightShip}.png" alt="Ship" style="opacity: 0;" />
                ${createOceanCurrents(2)}
                </section>
                ${createInstructionDialog(`
